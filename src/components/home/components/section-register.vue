<template>
  <section
    class="lg:mt-28 lg:py-24 py-20 lg:px-4 bg-[#FBFBFB] relative overflow-hidden"
  >
    <div class="container mx-auto relative z-50">
      <h3 class="text-3xl font-bold max-w-[400px]">
        Đăng kí nhận tư vấn và học thử
        <span class="text-primary text-3xl font-bold">miễn phí</span>
      </h3>
        ...
        <li>
          <a href="/" class="flex items-center space-x-4">
            ...
            >
              ...
              >
                <g clip-path="url(#messenger-icon)">
                  <path
    ...
    >
      <div class="min-w-[120%] w-full animation">
        <img
          src="https://asset.dolenglish.vn/resize=w:1080,fit:crop/r5OGZsFBQfSD8rRAhQCH"
          alt="about-dol"
        />
      </div>
      <div class="min-w-[120%] w-full animation">
